...
public class RMFurnaceContainer extends Container {
    ...
    public RMFurnaceTileEntity tileEntity;
    private IWorldPosCallable canInteractWithCallable;
    public FunctionalIntReferenceHolder currentSmeltTime;

    // Server Constructor
    public RMFurnaceContainer(final int windowID, final PlayerInventory playerInv,
                              final RMFurnaceTileEntity tile) {
        super(RMContainerTypes.EXAMPLE_FURNACE.get(), windowID);
    ...
    // Client Constructor
    public RMFurnaceContainer(final int windowID, final PlayerInventory playerInv, final PacketBuffer data) {
        this(windowID, playerInv, getTileEntity(playerInv, data));
    }

    private static RMFurnaceTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
        Objects.requireNonNull(playerInv, "playerInv cannot be null");
        Objects.requireNonNull(data, "data cannot be null");
        final TileEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof RMFurnaceTileEntity) {
            return (RMFurnaceTileEntity) tileAtPos;
        }
