...
public class RMFurnaceBlock extends Block {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tile instanceof RMFurnaceTileEntity) {
                ((RMFurnaceTileEntity) tile).customName = stack.getDisplayName();
            }
        }
    }
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
        TileEntity tile = worldIn.getTileEntity(pos);
        if (tile instanceof RMFurnaceTileEntity && state.getBlock() != newState.getBlock()) {
            RMFurnaceTileEntity furnace = (RMFurnaceTileEntity) tile;
            ((RMItemHandler) furnace.getInventory()).toNonNullList().forEach(item -> {
