...
class RMEbonyFurnaceScreen(private val screenContainerEbony: AbstractRMFurnaceContainer, inv: PlayerInventory, titleIn: ITextComponent) : ContainerScreen<AbstractRMFurnaceContainer?>(screenContainerEbony, inv, titleIn) {
    ...
    override fun drawGuiContainerForegroundLayer(mouseX: Int, mouseY: Int) {
        ...
        val curMana = screenContainerEbony.tileEntityFurnace.currentMana
        val maxMana = screenContainerEbony.tileEntityFurnace.maxMana
