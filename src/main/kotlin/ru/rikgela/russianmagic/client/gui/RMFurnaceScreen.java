...
public class RMFurnaceScreen extends ContainerScreen<RMFurnaceContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(MOD_ID,
            "textures/gui/rm_furnace_screen.png");

    public RMFurnaceScreen(RMFurnaceContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
